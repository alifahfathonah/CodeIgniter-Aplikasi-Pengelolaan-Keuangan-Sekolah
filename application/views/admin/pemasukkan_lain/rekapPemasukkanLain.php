      ...
      <div class="right_col" role="main">
        ...
        <div class="row">
            ...
            <div class="card mb-3">
              <div class="card-body">
                <div class="x_title" style="margin-bottom: 30px;">
                  <h2>Rekap Pemasukkan Lain </h2>
                  <div class="clearfix"></div>
                  
                </div>

                <div>
                  <form action="<?php echo site_url('admin/pemasukkan_lain/rekapPemasukkanLainGo') ?>" method="post" enctype="multipart/form-data" >
              ...
              <div class="card-body">
                <div class="x_title" >
                  ...
                  <div class="col-md-4 col-sm-4 label-align">
                    <h2 style="float: right;"> Pemasukkan Lain : 
                    </h2>
                  </div>
                  <div class="col-md-4 col-sm-4">
                    <div class="row"  align="center" >
                      <div class="top_tiles" >
                        <div class="tile">
                          <h2>Rp. <?php $this->load->helper('rupiah_helper'); echo rupiah($nominal_pemasukkan_lain->total) ?></h2>
                        </div>
          ...
          <div class="card mb-3">
            <div class="x_panel">
              <div class="x_title">
                <h2> List Pemasukkan Lain <?php $this->load->helper('bulan_helper'); echo bulan($bulan) ?> <?php echo $tahun ?></h2>
                <div class="clearfix"></div>
              </div>
              <div class="x_content">
                    ...
                    <div class="card-box table-responsive width">
                     <table id="" class="display table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        <?php 
                        $i = 1;
                        foreach ($pemasukkan_lain_group as $pemasukkan_lain_group1): ?>
                          <tr>
                            <td align="center"><?php echo $i ?></td>
                            <td><?php echo $pemasukkan_lain_group1->nama_kategori ?></td>
                            <td align="center"><?php echo $pemasukkan_lain_group1->total_kategori1 ?></td>
                            <td align="right" style="padding-right: 90px">
                              <?php $this->load->helper('rupiah_helper'); echo rupiah($pemasukkan_lain_group1->total_kategori); ?>
                            </td>
                            <!-- <td align="right" style="padding-right: 100px">Rp. <?php $this->load->helper('rupiah_helper'); echo rupiah($pemasukkan_lain_group1->total_kategori); ?></td> -->
                          </tr> 
                  ...
                  <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="profile-tab">
                    <div class="card-box table-responsive">
                     <table class="display table table-striped table-bordered " style="width:100%">
                      ...
                      <tbody>
                        <?php $j = 1; ?>
                        <?php foreach ($list_pemasukkan_lain as $pemasukkan_lain): ?>
                          <tr>
                            ...
                            <td align="right" style="padding-right: 30px;"> 
                                <?php $this->load->helper('rupiah_helper'); echo rupiah($pemasukkan_lain->nominal_pemasukkan_lain) ?>
                            </td>
                            <!-- <td align="right" ><?php $this->load->helper('rupiah_helper'); echo "Rp. ". rupiah($pemasukkan_lain->nominal_pemasukkan_lain) ?></td> -->
                            <td width="35%"><?php echo $pemasukkan_lain->keterangan_pemasukkan_lain?> 
                          </td>
