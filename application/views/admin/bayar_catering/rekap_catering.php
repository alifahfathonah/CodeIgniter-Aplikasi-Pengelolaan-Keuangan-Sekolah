      ...
      <div class="right_col" role="main">
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 ">
            ...
            <div class="card mb-3">
              <div class="card-body">
                <div class="x_title" style="margin-bottom: 30px;">
                  <h2>Rekap Pembayaran Catering </h2>
                  <div class="clearfix"></div>

                </div>

                <div>
                  <form action="<?php echo site_url('admin/bayar_catering/rekapCateringGo') ?>" method="post" enctype="multipart/form-data" >
              ...
              <div class="card-body">
                <div class="x_title" >
                  ...
                  <div class="col-md-4 col-sm-4 label-align">
                    <h2 style="float: right;"> Catering Sudah Terbayar : 
                    </h2>
                  </div>
                  <div class="col-md-4 col-sm-4">
                    <div class="row"  align="center" >
                      <div class="top_tiles" >
                        <div class="tile">
                          ...
                          <h2>Rp. <?php $this->load->helper('rupiah_helper'); echo rupiah($catering_terbayar->total) ?></h2>
                        </div>
            ...
            <div class="card-body">
              ...
              <div class="x_content">
                ...
                <div id="echart_pieCatering" style="height:450px;"></div>
          ...
          <div class="card mb-3">
            <div class="x_panel">
              <div class="x_title">
                <h2> Data Siswa Catering Bulan <?php $this->load->helper('bulan_helper'); echo bulan($bulan) ?> <?php echo $tahun ?></h2>
                <div class="clearfix"></div>
              </div>
              <div class="x_content">
                      ...
                      <tbody>
                        ...
                        foreach ($siswa_lunas as $siswa_lunas): ?>
                          <tr>
                            ...
                            <td align="center"><?php echo $siswa_lunas->kelas.$siswa_lunas->nama_kelas ?></td>
                          </tr> 
    ...
    <script type="text/javascript">
      ...
      function init_echarts() {
        ...
        var theme = {
         ...
         if ($('#echart_pieCatering').length ){  

          var echartPie = echarts.init(document.getElementById('echart_pieCatering'), theme);
