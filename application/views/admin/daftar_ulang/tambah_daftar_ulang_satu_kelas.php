          ...
          <div class="row">
            ...
            <?php } ?>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  <div class="x_title">
                    <h2 class="col-md-12 col-sm-12" style="text-align: center;">Tambah Pembayaran Daftar Ulang Satu Kelas</h2>
                    <div class="clearfix"></div>
                  </div>

                  <form action="<?php echo site_url('admin/daftar_ulang/addSatuKelas') ?>" method="post" enctype="multipart/form-data" >
